  ...
  <head>
	...
	<script language="javascript">
		...
		function CheckValid(){
		    ...
		    if(document.frmModify.email.value=="邮箱"){
		        alert("邮箱不能为空！");
		        document.rmModify.email.focus();
		        return false;
		    }
			else{
...
<body  style="background: url('imgs/bg.jpg'); ">
            	...
            	<div class="myform col-lg-6 animated" data-animation="flipInX" data-animation-delay="600" >
		         	 <form class=""  name="frmModify"  action="insertUser.php" method="post">	
		         	 <h3>会员登录</h3>						
						...
						<button type="submit"class="btn  animated"  data-animation="bounceIn" data-animation-delay="1200" onclick="return CheckValid()">
						 提交并跳转至登录</button>
					</form>
