...
<div class="myform col-lg-6 animated" data-animation="flipInX" data-animation-delay="600" >
 	 ...
 	 <h3>编辑用户</h3>						
		...
		<input id="name" class="form-control" type="text" required="required"  name="user_name"  placeholder="您的姓名" value="<?php echo $row['user_name'] ?>"/>
		<label for="name">密码</label>
		<input id="txt" type="text" placeholder="密码" name="password" class="form-control" value="<?php echo $row['password'] ?>">
		<label for="exampleInputName2">邮箱</label>
        <input type="text" name="email" class="form-control" placeholder="邮箱" value="<?php echo $row['email'] ?>">
